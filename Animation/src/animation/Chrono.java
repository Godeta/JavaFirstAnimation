...
public class Chrono {
	    ...
	    private long tempsActuel=0;
	    private long mil =0;

	    public void start()
	        {
	        tempsDepart=System.currentTimeMillis();
	        System.out.println("mil :"+ mil + " depart " + tempsDepart +"Wesh alors\n\n\n\n\n\n\n\n\n");
	        tempsFin=0;
	        pauseDepart=0;
	        pauseFin=0;
	        duree=0;
	    ...
	    public long getTemps() {
	    	...
	    	tempsActuel = (mil -tempsDepart) - (pauseFin-pauseDepart);
	    	//System.out.println("mil :"+ mil + " depart " + tempsDepart);
	    	return tempsActuel/1000;
	    }
